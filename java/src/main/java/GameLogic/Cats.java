...
public class Cats extends JComponent {
    ...
    private final Map<Integer, Double[]> CatSkillCorrelation = new HashMap<Integer, Double[]>() {
        {
            ...
            put(0, new Double[] { 550.0 , 1.9   , 125.0 , 1.0   }); // Relacion de "Osiris"
            ...
            put(14,new Double[] { 3000.0, 0.5   , 0.0   , 1.0   }); // Relacion de "Bastet"
    ...
    public void run() {
        ...
        if (currentPathIndex <= currentPath.getLength() - 1) {
            ...
            setVisible(false);
            Levels.reduceHealthOfPlayer((int)(reward * health));
        }
