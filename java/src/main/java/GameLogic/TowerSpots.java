...
public class TowerSpots {
    ...
    public static Map<Integer, ArrayList<HashMap<Point, Boolean>>> correlationTowersSpotAvailable = new HashMap<Integer, ArrayList<HashMap<Point, Boolean>>>() {
        {
            put(0, new ArrayList<HashMap<Point, Boolean>>() {
                {
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(385, 200), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(190, 310), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(540, 690), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(440, 450), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(750, 690), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(850, 460), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(1055, 590), true);
                        }
                    });
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(1010, 120), true);
                        }
                    });
                }
            });
            put(1, new ArrayList<HashMap<Point, Boolean>>() {
                {
                    add(new HashMap<Point, Boolean>() {
                        {
            ...
            put(2, new ArrayList<HashMap<Point, Boolean>>() {
                {
                    add(new HashMap<Point, Boolean>() {
                        {
                            put(new Point(0, 0), true);
    ...
    public static void changeSpotAvailability(int level, Point point, boolean isAvailable) {
        ...
        for (HashMap<Point, Boolean> spot : spots) {
            if (isInSpotRange(level, point)) {
                spot.replace(getPointInRange(level, point), true, false);
            }
        }
    }
